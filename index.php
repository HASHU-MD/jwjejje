...
<head>
    ...
    <title>RGR FREE WEB HOSTING | BY REHAN</title>
...
<body>
    <div class="container">
        ...
        <footer>
            <p style="font-size: 0.9rem;">DEVELOPED BY <strong style="color: #4cc9f0;">REHAN 🇱🇰</strong></p>
        </footer>
    </div>
    ...
    <script>
        ...
        function copyToClipboard(text) {
            navigator.clipboard.writeText(text).then(() => {
                showNotification('✅ URL COPIED TO CLIPBOARD SUCCESSFULLY!');
            }).catch(err => {
